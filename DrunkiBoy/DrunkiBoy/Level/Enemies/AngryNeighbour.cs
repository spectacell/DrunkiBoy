...
namespace DrunkiBoy
{
    class AngryNeighbour : Enemy
    {
        ...
        private double turnDelay, defaultTurnDelay = 500;
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (activePlatform != null && (pos.X >= activePlatform.pos.X + activePlatform.BoundingBox.Width - 95 || pos.X <= activePlatform.pos.X))
            {
                ChangeDirection();
            }
