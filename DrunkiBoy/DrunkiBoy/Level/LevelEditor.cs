    ...
    class LevelEditor : Level
    {
                ...
                switch (selectedItem)
                {
                    ...
                    case items.MovingPlatform:
                        if (intersectingPlatform != null)
                        {
                            if (mouseIsAt.X < intersectingPlatform.pos.X - selectedObject.BoundingBox.Width / 2) //Snap to left or right of exisisting platform
                            {
                                objects.Add(new MovingPlatform(new Vector2(intersectingPlatform.BoundingBox.Left - selectedObject.BoundingBox.Width, intersectingPlatform.pos.Y), Textures.MovingplatfForeditor, true));
                            }
                            else
                            {
                                objects.Add(new MovingPlatform(new Vector2(intersectingPlatform.BoundingBox.Right, intersectingPlatform.pos.Y), Textures.MovingplatfForeditor, true));
                            }
                        }
                        else
                        {
                            objects.Add(new MovingPlatform(new Vector2(mouseIsAt.X, mouseIsAt.Y), Textures.MovingplatfForeditor, true));
                        }
                        break;
                    ...
                    case items.Teleport:
                        if (intersectingPlatform != null)
                        {
                            objects.Add(new Teleport(new Vector2(mouseIsAt.X, intersectingPlatform.BoundingBox.Top - selectedObject.BoundingBox.Height), Textures.teleport, new Rectangle(0, 0, 98, 120), true, 1, 50));
                        }
                        else
                        {
                            objects.Add(new Teleport(new Vector2(mouseIsAt.X, mouseIsAt.Y), Textures.teleport, new Rectangle(0, 0, 98, 120), true, 1, 50));
                        }
                        break;
                    case items.Money:
                        if (intersectingPlatform != null)
                    ...
                    case items.Button:
                        if (intersectingPlatform != null)
                        {
                            objects.Add(new Button(new Vector2(mouseIsAt.X, intersectingPlatform.BoundingBox.Top - selectedObject.BoundingBox.Height), Textures.Button, true));
                        }
                        else
                        {
                            objects.Add(new Button(new Vector2(mouseIsAt.X, mouseIsAt.Y), Textures.Button, true));
                        }
        ...
        private void SelectItemBasedOnKeyInput()
        {
            ...
            if (KeyMouseReader.KeyPressed(Keys.F))
            {
                ...
                selectedObject = new Teleport(new Vector2(mouseState.X, mouseState.Y), Textures.teleport, new Rectangle(0, 0, 98, 120), true, 1, 50);
            }
            ...
            if (KeyMouseReader.KeyPressed(Keys.N))
            {
                ...
                selectedObject = new MovingPlatform(new Vector2(mouseState.X, mouseState.Y), Textures.MovingplatfForeditor, true);
            }
