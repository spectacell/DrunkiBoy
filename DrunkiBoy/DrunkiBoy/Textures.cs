...
namespace DrunkiBoy
{
    class Textures
    {
        public static Texture2D player, player_lower_body, player_upper_body, player_upper_body_hurt, player_burger, player_shooting, player_pizza, player_bottle, DoorOpened, MovingplatfFöreditor, wall, ActiveButton,
