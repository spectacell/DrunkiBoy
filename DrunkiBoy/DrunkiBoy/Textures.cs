...
namespace DrunkiBoy
{
    class Textures
    {
        ...
        public static Texture2D platform, background1, background2, deleteCursor, torchTex, Key, heart, bottle, bottle_molotov, hamburgare, pizza, painkiller, teleport, AktivTeleport, smokeTexture, explosionTexture;
